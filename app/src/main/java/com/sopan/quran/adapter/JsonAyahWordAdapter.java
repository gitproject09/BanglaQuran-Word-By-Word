...
import com.sopan.quran.activity.TafsirActivity;
import com.sopan.quran.database.datasource.AyahWordDataSource;
import com.sopan.quran.database.datasource.CorpusDataSource;
import com.sopan.quran.model.AyahWord;
import com.sopan.quran.model.Corpus;
import com.sopan.quran.model.Word;
...
public class JsonAyahWordAdapter extends RecyclerView.Adapter<JsonAyahWordAdapter.AyahViewHolder> {
    ...
    public void onBindViewHolder(JsonAyahWordAdapter.AyahViewHolder holder, int position) {
        ...
        int ayatNumb = Math.toIntExact(ayahWord.getQuranVerseId()) + 1;
        ...
        holder.verse_idTextView.setText("(" + SettingsActivity.replaceBanglaText(context, "" + ayatNumb) + ")");
